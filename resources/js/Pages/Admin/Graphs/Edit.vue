...
<admin>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <template v-if="this.options.chart.type !== 'scatter'">
      <apex-chart 
      ...
      <apex-chart 
      v-if="this.options.chart.type === 'donut'"
      class="w-full border-2" 
      :height="'400px'" 
      type="donut" 
      :options="chartOptions" 
      ...
      <apex-chart 
      v-if="this.options.chart.type !== 'pie' && this.options.chart.type !== 'donut'"
      class="w-full border-2" 
      :height="'400px'" 
      type="bar" 
      :options="chartOptions" 
  ...
  <div class="max-w-7xl mx-auto px-4 mt-6 grid grid-cols-3">
    ...
    <div class="text-center col-span-1">
      <div 
        @click="generateData" 
        :class=""
        class="w-12 h-12 m-auto rounded-full flex justify-center items-center bg-teal-500 cursor-pointer">
  ...
  <draggable v-model="rows" group="series" handle=".series-drag">
    ...
    <div class="flex flex-col bg-gray-50" style="width: 24em">
      <div class="h-0 flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div class="px-4">
          ...
          <div class="flex mb-6">
            <button @click="submit"
              class="w-full p-2 r-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-teal-500 hover:bg-teal-500 focus:outline-none focus:border-teal-700 focus:shadow-outline-teal active:bg-teal-700 transition ease-in-out duration-150">
          ...
          <div class="-mx-4">
            <div class="border-t-3 border-b-3 border-gray-100 p-2 px-4 flex items-center justify-between">
              ...
              <button 
                ...
                :class="(sidebar.datalabelsAcc) ? 'rotate-45' : 'rotate-0'" 
                class="transform focus:outline-none text-teal-500 duration-200 transition-all cursor-pointer">
                <i  class="fad fa fa-plus"></i>
              </button>
            </div>
...
export default {
  ...
  methods: {
    ...
    /*
     *
     * Temp functions for faster HMR while in dev, All items here should be moved back to Mixins
     * 
     * 
     */
